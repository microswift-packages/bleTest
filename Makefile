...
ALL_TARGETS := clean_buildlog packages $(ELF_FILE) $(ERROR_LOG) runtime_absence_check abort_check
...
ifeq ($(PACKAGE_MODULES_DIR),)
$(error You must set PACKAGE_MODULES_DIR)
endif
...
# put the module.modulemap and associated headers in the top level directory of the package
